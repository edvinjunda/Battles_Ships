...
const char* other_coordinates = "  Enter other coordinates: ";
const char* won = "  You won!";
const char* lost = "  You lost!";
const char* player_ship_points = "  Your ship points:    ";
const char* enemy_ship_points = "  Enemy's ship points: ";
const char* ship_placement = "  If you want place ships ";
